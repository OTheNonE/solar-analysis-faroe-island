...
export async function getRidgePoints(pos: Pos) {
  ...
  // const worker = new Worker(new URL("src/lib/Functions/CalculateRidge.ts", document.URL), { type: 'module' })
  // const worker = new Worker("src/lib/Functions/CalculateRidge.ts", { type: 'module' })
